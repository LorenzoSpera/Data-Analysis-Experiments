...
void data_analysis_efficiency() {
    ...
    TGraphErrors* graph = new TGraphErrors(size, V_B.data(), efficiency.data(), nullptr, errors_bi.data());

    graph->SetTitle("Efficienza vs V_B (binomial);V_B [V];Efficienza");
    ...
    TGraphErrors* graph_deA = new TGraphErrors(size, V_B.data(), efficiency_deA.data(), nullptr, errors_deA.data());

    graph_deA->SetTitle("deAgostini Efficienza vs V_B;V_B [V];Efficienza");
